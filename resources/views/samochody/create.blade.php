...
<form class="col-12 col-lg-12" enctype="multipart/form-data" action="{{ route('samochody.store') }}"
    ...
    <div class="form-group col-12">
        ...
        <div>
                <input id="kolor" type="text" class="form-control sqinput" name="kolor" value="" required autofocus>
                @if ($errors->has('kolor'))
                <span class="help-block">
        ...
        <div class="form-group col-12">
            ...
            <div>
                <select class="form-control sqinput" name="rodzaj_paliwa">
                    ...
                    <option value="hybryda samoładująca">Hybryda samoładująca</option>
                </select>
            </div>
        </div>
        <div class="form-group col-12">
            ...
            <div>
            <input id="pojemnosc" type="text" class="form-control sqinput" name="pojemnosc" value="" required autofocus>
